...
public class Perdiste extends javax.swing.JFrame {
    ...
    Perdedor colgado = new Perdedor();
    
    public Perdiste() {
        this.setContentPane(colgado);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("La verdad que sos un desastre. No servís para este juego!!");
    ...
    class Perdedor extends JPanel{
        private Image pulgar_abajo;
        
        @Override
        public void paint(Graphics ij){
            pulgar_abajo = new ImageIcon(getClass().getResource("/img_ahorcado/pulgar_abajo.png")).getImage();
            ij.drawImage(pulgar_abajo, 0, 0, getWidth(), getHeight(), this);
            setOpaque(false);
            super.paint(ij);
        }
    }
